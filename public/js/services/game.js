angular.module('mean.system')
    .factory('game', ['socket', '$timeout', '$http', function(socket, $timeout, $http) {
        ...
        socket.on('gameUpdate', function(data) {
            ...
            // var playersInfo = [];
            // console.log(game.players, 'players list');
            // for (var i in game.players) {
            //     var name = {};

            //     name.names = game.players[i].username;
            //     name.avatar = game.players[i].avatar;
            //     playersInfo.push(name);
            // }
            // console.log(playersInfo, 'names');
            // console.log(game.gameWinner, 'winner');
            // for (var win = 0; win < playersInfo.length; win++) {
            //     if (game.gameWinner === playersInfo.indexOf(win)) {
            //         console.log("The winner is", playersInfo.username);
            //     }
            // }
        });
