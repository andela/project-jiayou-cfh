...
module.exports = function(app, passport, auth) {
    ...
    var games = require('../app/controllers/gamehistory');
    ...
    // game authenticate users
    // app.get('/api/games/:id/startnow', users.authenticate);
    //game history
    app.post('/api/games/:id/start', users.authenticate, games.createGame);
